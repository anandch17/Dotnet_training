...
namespace EventHandling
{
    ...
    class ProduceMango
    {
        public event EventHandler<MangoEventArgs> MangoInfo; string Mango;
        ...
        {
            int i = new Random().Next(1000); string mangoinfo = i + " " + Mango + " mangoes produced "; Console.WriteLine(mangoinfo); if (MangoInfo != null)
            {
    ...
    internal class Program
    {
            ...
            ProduceMango SalemFarms = new ProduceMango("Alphanso");// Slice registers event with SalemFarms
